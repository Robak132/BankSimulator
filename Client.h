...
public:
    ...
    virtual possible_operations getReason() = 0;
    ...
    virtual void setReason(possible_operations _reason) = 0;
...
private:
    ...
    possible_operations client_reason;
    int money;

    Account account;
    bool checkDocID(string _document_id);
public:
    Client(string _name, string _surname, string _document_id, ID _id_number=ID('C'), possible_operations reason = static_cast<possible_operations>(0), int money = 0, Account _account = Account());
    ...
    void setReason(possible_operations _reason);
...
public:
    BusinessClient(string _name, string _surname, string _document_id, ID _id_number=ID('C'), possible_operations _reason=static_cast<possible_operations>(0), int _money = 0, Account _account = Account())
...
public:
    IndividualClient(string _name, string _surname, string _document_id, ID _id_number=ID('C'), possible_operations _reason=static_cast<possible_operations>(0), int _money = 0, Account _account = Account())
        : Client(_name, _surname, _document_id, _id_number, _reason, _money, _account) {
        setType("Individual");
    }
};
